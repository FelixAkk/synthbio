...
\item[3. Design circuit] \textit{The user must be able to design a circuit by specifying gates (using a drag-and-drop) and the relations between these gates.}
	...
	Gates are visualized using a simple, yet distinctive image (figure 6.A). They can be dragged from the list and dropped into the workspace (figure 6.D).
...
Here each team member gives a summary of their experience and analysis of the project.
