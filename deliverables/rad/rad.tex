...
\begin{enumerate}
\item \textbf{Documentation} For documentation we will use \LaTeX  to finalize the reports and will be written in English. GIT will be used for hosting and collaborating on documentation\footnote{Git repository @github: \url{https://github.com/FelixAkk/synthbio}}.
...
\subsubsection{Business Object model} % (Albert)
