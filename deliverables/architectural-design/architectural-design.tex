...
Since SBML is an available standard and defferential equation solvers exist for this format, we'll use it to run the simulation. The circuit will be represented in SBML and imported in the solver. The solver well respond with concentrations of different species\footnote{SBML term for different signals in the simulation} as a function of time.
